<?php
	...
	if (isset($_POST["new-password"])) {
		$ONew=UsuarioController::modificarPassword();
	}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Mochima | Crear Contraseña</title>
   <!-- Favicon -->
...
<div class="prueba-1 d-flex justify-content-center align-items-center">
	<div class="box" style="z-index: 100;">
		<div class="mb-3 mt-3">
			...
			<h1 class="text-white text-center mb-4" style="font: bold 30px 'roboto' , roboto;">Crear Contraseña</h1>
			<h3 class="text-white text-center mb-3" style="font: normal 15px 'roboto' , roboto;">Ingresar la nueva contraseña de tu cuenta.</h3>
		</div>
